...
class OrganizationEventAttachments
{
    private $_table = 'event_file_attachments';
    private $_sorts = array('attachment_name' => 'ASC');
    private $_type = null;
    private $_start = 0;
    private $_limit = 0;
    private $_fkey = 'event_id';
    ...
    public function getList()
    {
        ...
        $sql = 'SELECT *, IF(LENGTH(attachment_name) > 25,  CONCAT(LEFT(attachment_name, 25), "..."), attachment_name) attachment_shortname
