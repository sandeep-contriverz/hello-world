$(document).ready(function(){
	// Auto suggest code
	$("#referralDiv, #followUpDiv, .setting-autosuggest,#searchFieldForm").on('click', ".autosuggest-input", function(e){
		$(document).unbind('keydown');
		$(this).select();
	});
	$("#referralDiv, #followUpDiv, .setting-autosuggest,#searchFieldForm").on('blur', ".autosuggest-input", function(e){
	...
	$("#referralDiv, #followUpDiv, .setting-autosuggest,#searchFieldForm").on('keydown', ".autosuggest-input", function(e){
		var keycode = e.which;
		if(keycode == 13){
			e.preventDefault();
		}
	...
	$("#referralDiv, #followUpDiv, .setting-autosuggest,#searchFieldForm").on('keyup', ".autosuggest-input", function(e){
		var keycode = e.which;
    ...
    $('#referralDiv, #followUpDiv, .setting-autosuggest,#searchFieldForm').on('keydown', '.pitem', function(event){
	...
	$("#referralDiv, #followUpDiv, .setting-autosuggest,#searchFieldForm").on('click', ".autosuggest-selection-container a", function(e){
		e.preventDefault();
		var listContainer = $(this).parent('.autosuggest-selection-container');
	    var autoSuggestInput = listContainer.prev('.autosuggest-input');
