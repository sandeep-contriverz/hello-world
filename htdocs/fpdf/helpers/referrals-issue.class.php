...
class PdfReferralsIssue extends FPDF
{
    ...
    function Header()
    {
        ...
        if($this->PageNo() > 1){
            ...
            $this->Cell(0,40,'Referrals By Issue (cont.)',0,1,'L');

            $this->SetFont('Arial','B',12);
            $this->Cell(114.18,20.87,$this->issue['name'],0,0,'L');
            ...
            //$this->Ln(20);
            // Title
            $this->Cell(0,57.14,'Referrals By Issue',0,1,'L');
    ...
    function IssueInformation($info = array()){
        ...
        $columnY = $this->getY();
        $this->SetFont('Arial','B',12);
        $this->Cell($this->GetStringWidth('Issue: '),20.87,'Issue:',0,0,'L');
        $this->SetFont('Arial','',11);
