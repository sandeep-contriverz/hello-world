...
class PdfReferralsAgencyChild extends FPDF
{
    ...
    function AgencyInformation($info = array()){
        ...
        $columnY = $this->getY();
        $this->SetFont('Arial','B',12);
        $this->Cell($this->GetStringWidth('Children Referred To: '),20.87,'Children Referred To:',0,0,'L');
        $this->SetFont('Arial','',11);
    ...
    function ReferralList($columns = array(), $data = array()){
        ...
        foreach ($data as $records) {
            foreach ($records as $row) {
                ...
                $childName    = $this->NbLines($row['Child Name'], 60);
        ...
        // Totals
        $this->MultiCell(530, 20, 'Totals: ' . $totalRecords, '3', 'R', 0);
    }
