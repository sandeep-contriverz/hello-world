...
class PdfReferralsService extends FPDF
{
    ...
    function Header()
    {
        ...
        if($this->PageNo() > 1){
            ...
            $this->Cell(0,40,'Referrals By Service (cont.)',0,1,'L');

            $this->SetFont('Arial','B',12);
            $this->Cell(114.18,20.87,$this->service['name'],0,0,'L');
            ...
            //$this->Ln(20);
            // Title
            $this->Cell(0,57.14,'Referrals By Service',0,1,'L');
    ...
    function ServiceInformation($info = array()){
        ...
        $columnY = $this->getY();
        $this->SetFont('Arial','B',12);
        $this->Cell($this->GetStringWidth('Service: '),20.87,'Service:',0,0,'L');
        $this->SetFont('Arial','',11);
    ...
    */
    ...
    function ReferralList($columns = array(), $data = array()){
        ...
        foreach ($data as $row) {
            ...
            $referral = $this->NbLines($row['Referral Name'], 250);
            $outcome = $this->NbLines($row['Outcome'], 170);
